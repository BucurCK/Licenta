...
float k_p = 0.6, k_i = 0.009;
float k_p_i_q = 0.6, k_i = 0.009;
...
int32_t sat_out_currents = 15000;					//-40[A] & 40[A]	15000 ~ 18A
int32_t sat_out_spd = 30;							//-983010[rpm] & 983010[rpm]
int32_t sat_out_pos = 100;							//-32bit[iu]	+32bit[iu]
